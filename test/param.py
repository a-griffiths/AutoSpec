# Default configuration file for AutoSpec v 1.0.1
# DATE: 23-07-2018

# ----------- Operating Mode --------------------------------------------------------------------------------------------------------------------------------

MODE           = 'same'                        # 'same' or 'cat' to use configuration or catalogue file respectively for object extraction mode (string). 

# ----------- Reference Spectra -----------------------------------------------------------------------------------------------------------------------------

REF            = 'G-Band'                      # reference spectrum to use for cross correlation, weight image names or aperture size (string).
...
# ----------- Datacube Extension: Use if datacube extensions are not specified in headers -------------------------------------------------------------------

DATA_EXT       = ()                            # The number/name of the data and/or variance extensions (int, int) or (str, str), () if none.
